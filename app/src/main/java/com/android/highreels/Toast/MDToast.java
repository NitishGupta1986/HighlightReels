package com.android.highreels.Toast;
...
public class MDToast extends Toast {
    ...
    public static MDToast makeText(Context context, String message, int duration, int type) {
        ...
        View view = inflater.inflate(R.layout.toast_container, null);

        ImageView icon = view.findViewById(R.id.icon);
        RegularTextView text = view.findViewById(R.id.text);

        switch (type) {
            case TYPE_SUCCESS:
                icon.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.ic_baseline_check_circle_24));
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                    view.setBackground(ContextCompat.getDrawable(context, R.drawable.toast_success_background));
                } else
            ...
            case TYPE_WARNING:
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                    view.setBackground(ContextCompat.getDrawable(context, R.drawable.toast_warn_background));
                } else
            ...
            case TYPE_ERROR:
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                    view.setBackground(ContextCompat.getDrawable(context, R.drawable.toast_error_background));
            ...
            default:
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                    view.setBackground(ContextCompat.getDrawable(context, R.drawable.toast_info_background));
